...
export default function MarioPikachu() {
  return (
    <section className="p-8 border-t-2 border-yellow h-full overflow-auto">
      ...
      <div className="flex flex-col-reverse md:flex-row w-full max-w-screen-xl mx-auto">
        <div className="flex-1 font-body text-xl md:pr-8">
          <p>
            In October of 2016, the Pokemon company issued a special edition
            gift box in Japan as part of a crossover campaign between the Super
            Mario and Pokemon franchises. Part of the gift box was a set of 4
            pokemon cards featuring Pikachu as Mario or Luigi, with the Mario
            full art card being the most popular.
          </p>
          <p className="mt-2">
            This PSA 10 example of the card was purchased by mannyDAO on
            3/20/2022 after an overwhelmingly positive proposal.
          </p>
        </div>

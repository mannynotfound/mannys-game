...
export default function Cryptoad() {
  return (
      ...
      <div className="flex flex-col-reverse md:flex-row w-full max-w-screen-xl mx-auto">
        <div className="flex-1 font-body text-xl md:pr-8">
          <p>
            ...
            This lasagna toad sports a gold Rolex and sits on a salmon
            background, staring down the viewer with judgemental eyes.
            Originally purchased by manny on 10/2/2021 and donated to the DAO on
            1/30/2022.
          </p>
        </div>

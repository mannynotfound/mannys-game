module.exports = {
  abi: [
    ...
    { inputs: [], name: 'InvalidGovernanceOptionsError', type: 'error' },
    {
    ...
    { inputs: [], name: 'MissingHostsError', type: 'error' },
    { inputs: [], name: 'NoContributionsError', type: 'error' },
    { inputs: [], name: 'NoPartyError', type: 'error' },
    {
      inputs: [
    ...
    { inputs: [], name: 'NothingToClaimError', type: 'error' },
    { inputs: [], name: 'OnlyConstructorError', type: 'error' },
    { inputs: [], name: 'OnlyContributorError', type: 'error' },
    { inputs: [], name: 'OnlyDelegateCallError', type: 'error' },
    {
      inputs: [{ internalType: 'address', name: 'notDao', type: 'address' }],
    ...
    { inputs: [], name: 'SplitRecipientAlreadyBurnedError', type: 'error' },
    {
    ...
    },
    {
      inputs: [
        ...
        {
          components: [
            { internalType: 'address[]', name: 'hosts', type: 'address[]' },
        ...
        { internalType: 'uint256', name: 'hostIndex', type: 'uint256' },
      ],
      name: 'buy',
      outputs: [
        { internalType: 'contract Party', name: 'party_', type: 'address' },
      ],
      stateMutability: 'nonpayable',
      type: 'function',
    },
    ...
    },
    {
      ...
      outputs: [
        ...
        { internalType: 'uint256', name: 'governanceTokenId', type: 'uint256' },
      ],
      stateMutability: 'view',
      type: 'function',
    },
    ...
    },
    {
      ...
      name: 'gateKeeper',
      outputs: [
        { internalType: 'contract IGateKeeper', name: '', type: 'address' },
      ],
      stateMutability: 'view',
      type: 'function',
    },
    ...
    },
    {
      ...
      outputs: [
        { internalType: 'uint256', name: 'ethContributed', type: 'uint256' },
        { internalType: 'uint256', name: 'ethUsed', type: 'uint256' },
        { internalType: 'uint256', name: 'ethOwed', type: 'uint256' },
      ...
      inputs: [
        {
          components: [
            ...
            { internalType: 'uint16', name: 'splitBps', type: 'uint16' },
            {
              internalType: 'address',
    ...
    },
    {
      inputs: [],
      name: 'party',
      outputs: [{ internalType: 'contract Party', name: '', type: 'address' }],
      stateMutability: 'view',
      type: 'function',
    },
    {
